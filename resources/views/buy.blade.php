                        ...
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2">
                                        <input class="form-control" type="text" disabled value="{{$account['net_asset']}}"/>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                    <input class="form-control" type="text" disabled value="{{$account['available_cny_display']}}"/>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">冻结人民币</label>
                                    <div class="col-sm-2">
                                        <input class="form-control" type="text" disabled value="{{$account['frozen_cny_display']}}"/>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                    <input class="form-control" type="text" disabled value="{{$account['available_ltc_display']}}"/>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">可用比特币</label>
                                    <div class="col-sm-2">
                                        <input class="form-control" type="text" disabled value="{{$account['available_btc_display']}}"/>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                    <input class="form-control" type="text" disabled value="{{$account['frozen_btc_display']}}"/>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">冻结莱特币</label>
                                    <div class="col-sm-2">
                                        <input class="form-control" type="text" disabled value="{{$account['frozen_ltc_display']}}"/>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                    <input class="form-control" type="text" disabled value="{{$account['loan_btc_display']}}"/>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">申请莱特币数量</label>
                                    <div class="col-sm-2">
                                        <input class="form-control" type="text" disabled value="{{$account['loan_ltc_display']}}"/>
                                    </div>
                                </div>
                            </div>
                        </fieldset>
